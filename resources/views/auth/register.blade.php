                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="nisn" placeholder="{{ __('NISN') }}" value="{{ old('nsin') }}" required autofocus>
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="kelas" placeholder="{{ __('Kelas') }}" value="{{ old('kelas') }}" required autofocus>
                                    </div>
